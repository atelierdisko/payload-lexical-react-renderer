...
describe("Testing custom list renderers", async () => {
  render(
    <PayloadLexicalReactRenderer
      elementRenderers={{
        ...defaultElementRenderers,
  ...
  const unorderedLists = await screen.getAllByRole("list", { name: "bullets" });
  const orderedLists = await screen.getAllByRole("list", { name: "numbered" });
